      ...
      import { createHardwareRenderHelpers } from './features/hardware-inspector/core.js';
      ...
      const { hardwareReadableText, hardwareOverviewBytes, hardwareOverviewSection } =
        createHardwareRenderHelpers({ t, getLang, escapeHtml });
      ...
      document.getElementById('imageStitchCancel')?.addEventListener('click', () => {
        ...
        tauriCorePromise.then(({ invoke }) => invoke('cancel_convert')).catch(() => {});
      });
